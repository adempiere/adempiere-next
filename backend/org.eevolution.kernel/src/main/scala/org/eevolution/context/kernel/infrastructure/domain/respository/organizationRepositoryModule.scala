...
import org.eevolution.context.kernel.infrastructure.domain.respository.organizationRepositoryBase
import zio.ZLayer
import zio.blocking.Blocking

package object organizationRepositoryModule extends organizationRepositoryBase {
  ...
  object OrganizationRepositoryLayer {
    val live: ZLayer[
