...
import org.eevolution.context.kernel.infrastructure.database.{
  DatabaseConfig,
  databaseConfigProviderApiAccessors
}
import zio.{Has, ZIO}

package object databaseConfigProviderApi
    extends databaseConfigProviderApiAccessors {
  type DatabaseConfigProvider = Has[DatabaseConfigProvider.Service]
