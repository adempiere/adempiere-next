...
import org.eevolution.context.dictionary.domain.service.entityServiceBase
import zio.ZLayer

package object entityServiceModule extends entityServiceBase {

  private case class Live(
      entityRepository: EntityRepository.Service
  ) extends Service(entityRepository)

  object EntityServiceLayer {
    val live: ZLayer[EntityRepository, Nothing, EntityService] =
      ZLayer.fromService(entityRepository => Live(entityRepository))
  }
