...
trait entityServiceApiAccessors {
  def getById(
      id: Id
  ): RIO[EntityService with EntityRepository, Option[Entity]] =
    RIO.accessM(_.get.getById(id))

  def getByEntityType(
      entityType: EntityType
  ): RIO[EntityService with EntityRepository, List[Entity]] =
    RIO.accessM(_.get.getByEntityType(entityType))

  def getAll: RIO[EntityService with EntityRepository, List[Entity]] =
  ...
  def save(
      element: Entity
  ): RIO[EntityService with EntityRepository, Entity] =
