...
import org.eevolution.context.dictionary.infrastructure.domain.repository.attributeRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.ZLayer
import zio.blocking.Blocking

package object attributeRepositoryModule extends attributeRepositoryBase {
  ...
  object AttributeRepositoryLayer {
    val live: ZLayer[
