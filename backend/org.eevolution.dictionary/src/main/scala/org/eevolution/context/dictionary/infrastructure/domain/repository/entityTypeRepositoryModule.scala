...
import org.eevolution.context.dictionary.infrastructure.domain.repository.entityTypeRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.ZLayer
import zio.blocking.Blocking

package object entityTypeRepositoryModule extends entityTypeRepositoryBase {
  ...
  object EntityTypeRepositoryLayer {
    val live: ZLayer[
