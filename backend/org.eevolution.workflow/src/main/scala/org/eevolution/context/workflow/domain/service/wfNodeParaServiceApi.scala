...
import org.eevolution.context.workflow.domain.service.{
  wfNodeParaServiceApiAccessors,
  wfNodeParaServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfNodePara Service Api Package Object for WfNodePara Domain Service
*
* Is a contract to define the service api WfNodePara Domain Service
...
*/
package object wfNodeParaServiceApi extends wfNodeParaServiceApiAccessors {

type WfNodeParaService = Has[WfNodeParaService.Service]

object WfNodeParaService {

     trait Service extends wfNodeParaServiceApiBase[WfNodeParaRepository] {
