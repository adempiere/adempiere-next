...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfNodeParaRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfNodePara Repository Module Package Object with the implementation for WfNodePara Repository
*
* Default implementation to WfNodePara Repository Base
...
*/
package object wfNodeParaRepositoryModule extends wfNodeParaRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfNodeParaRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfNodeParaRepository] =
      ZLayer.fromServices[
