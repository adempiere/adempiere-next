...
import org.eevolution.context.workflow.domain.service.{
  wfEventAuditServiceApiAccessors,
  wfEventAuditServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfEventAudit Service Api Package Object for WfEventAudit Domain Service
*
* Is a contract to define the service api WfEventAudit Domain Service
...
*/
package object wfEventAuditServiceApi extends wfEventAuditServiceApiAccessors {

type WfEventAuditService = Has[WfEventAuditService.Service]

object WfEventAuditService {

     trait Service extends wfEventAuditServiceApiBase[WfEventAuditRepository] {
