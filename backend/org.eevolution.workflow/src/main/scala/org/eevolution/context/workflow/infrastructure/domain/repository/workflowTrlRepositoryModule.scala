...
import org.eevolution.context.workflow.infrastructure.domain.repository.workflowTrlRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WorkflowTrl Repository Module Package Object with the implementation for WorkflowTrl Repository
*
* Default implementation to WorkflowTrl Repository Base
...
*/
package object workflowTrlRepositoryModule extends workflowTrlRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WorkflowTrlRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WorkflowTrlRepository] =
      ZLayer.fromServices[
