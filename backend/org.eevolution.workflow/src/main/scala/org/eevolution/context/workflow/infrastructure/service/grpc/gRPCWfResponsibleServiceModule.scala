...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfResponsibleServiceBase

/*
* gRPC WfResponsible Service Module Package Object with the implementation for gRPC WfResponsible Service
*
* Default implementation to gRPC WfResponsible Service Base
...
*/
package object gRPCWfResponsibleServiceModule extends gRPCWfResponsibleServiceBase {

  object Service extends Service[WfResponsibleService with WfResponsibleRepository] {
