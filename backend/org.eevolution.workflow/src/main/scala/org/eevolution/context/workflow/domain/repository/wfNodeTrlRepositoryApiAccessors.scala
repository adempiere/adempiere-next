...
/**
* Accessors method Trait for WfNodeTrl Repository 
*
...
*/
trait wfNodeTrlRepositoryApiAccessors {


  def getAll: RIO[WfNodeTrlRepository, List[WfNodeTrl]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WfNodeTrlRepository, List[WfNodeTrl]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
  def save(wfNodeTrl: WfNodeTrl): RIO[WfNodeTrlRepository, WfNodeTrl] = 
