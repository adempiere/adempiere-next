...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfProcessServiceBase

/*
* gRPC WfProcess Service Module Package Object with the implementation for gRPC WfProcess Service
*
* Default implementation to gRPC WfProcess Service Base
...
*/
package object gRPCWfProcessServiceModule extends gRPCWfProcessServiceBase {

  object Service extends Service[WfProcessService with WfProcessRepository] {
