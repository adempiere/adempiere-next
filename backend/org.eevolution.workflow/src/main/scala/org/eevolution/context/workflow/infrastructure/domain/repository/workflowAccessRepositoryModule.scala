...
import org.eevolution.context.workflow.infrastructure.domain.repository.workflowAccessRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WorkflowAccess Repository Module Package Object with the implementation for WorkflowAccess Repository
*
* Default implementation to WorkflowAccess Repository Base
...
*/
package object workflowAccessRepositoryModule extends workflowAccessRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WorkflowAccessRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WorkflowAccessRepository] =
      ZLayer.fromServices[
