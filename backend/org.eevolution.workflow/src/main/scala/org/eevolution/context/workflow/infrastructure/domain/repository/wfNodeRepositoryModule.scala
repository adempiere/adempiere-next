...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfNodeRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfNode Repository Module Package Object with the implementation for WfNode Repository
*
* Default implementation to WfNode Repository Base
...
*/
package object wfNodeRepositoryModule extends wfNodeRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfNodeRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfNodeRepository] =
      ZLayer.fromServices[
