...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWorkflowProcessorServiceBase

/*
* gRPC WorkflowProcessor Service Module Package Object with the implementation for gRPC WorkflowProcessor Service
*
* Default implementation to gRPC WorkflowProcessor Service Base
...
*/
package object gRPCWorkflowProcessorServiceModule extends gRPCWorkflowProcessorServiceBase {

  object Service extends Service[WorkflowProcessorService with WorkflowProcessorRepository] {
