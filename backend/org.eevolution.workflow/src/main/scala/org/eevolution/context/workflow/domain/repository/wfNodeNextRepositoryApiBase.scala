...
/*
* WfNodeNext Repository Api Base Trait for WfNodeNext Repository
*
* Is a contract to define the repository api base WfNodeNext Repository
* This class should not be modified since it is generated from the Application Dictionary 
* maybe any change made manually will be lost.
*/
trait wfNodeNextRepositoryApiBase[-R] {
