...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfNodeNextRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfNodeNext Repository Module Package Object with the implementation for WfNodeNext Repository
*
* Default implementation to WfNodeNext Repository Base
...
*/
package object wfNodeNextRepositoryModule extends wfNodeNextRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfNodeNextRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfNodeNextRepository] =
      ZLayer.fromServices[
