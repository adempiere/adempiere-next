...
import org.eevolution.context.workflow.domain.repository.{
  workflowRepositoryApiAccessors,
  workflowRepositoryApiBase
}
...
/*
* Workflow Repository Api Package Object for Workflow Repository
*
* Is a contract to define the repository api Workflow Repository
...
*/
package object workflowRepositoryApi extends workflowRepositoryApiAccessors {

  type WorkflowRepository = Has[WorkflowRepository.Service]
  
  object WorkflowRepository {
            trait Service extends workflowRepositoryApiBase[WorkflowRepository] {
    }
  }
}  
