...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfEventAuditRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfEventAudit Repository Module Package Object with the implementation for WfEventAudit Repository
*
* Default implementation to WfEventAudit Repository Base
...
*/
package object wfEventAuditRepositoryModule extends wfEventAuditRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfEventAuditRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfEventAuditRepository] =
      ZLayer.fromServices[
