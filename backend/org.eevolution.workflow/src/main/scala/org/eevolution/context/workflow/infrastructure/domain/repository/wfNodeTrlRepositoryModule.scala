...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfNodeTrlRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfNodeTrl Repository Module Package Object with the implementation for WfNodeTrl Repository
*
* Default implementation to WfNodeTrl Repository Base
...
*/
package object wfNodeTrlRepositoryModule extends wfNodeTrlRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfNodeTrlRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfNodeTrlRepository] =
      ZLayer.fromServices[
