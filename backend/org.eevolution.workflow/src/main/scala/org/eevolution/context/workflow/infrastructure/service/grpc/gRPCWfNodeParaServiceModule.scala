...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfNodeParaServiceBase

/*
* gRPC WfNodePara Service Module Package Object with the implementation for gRPC WfNodePara Service
*
* Default implementation to gRPC WfNodePara Service Base
...
*/
package object gRPCWfNodeParaServiceModule extends gRPCWfNodeParaServiceBase {

  object Service extends Service[WfNodeParaService with WfNodeParaRepository] {
