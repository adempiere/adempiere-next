...
/**
* Accessors method Trait for WorkflowTrl Repository 
*
...
*/
trait workflowTrlRepositoryApiAccessors {


  def getAll: RIO[WorkflowTrlRepository, List[WorkflowTrl]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WorkflowTrlRepository, List[WorkflowTrl]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
  def save(workflowTrl: WorkflowTrl): RIO[WorkflowTrlRepository, WorkflowTrl] = 
