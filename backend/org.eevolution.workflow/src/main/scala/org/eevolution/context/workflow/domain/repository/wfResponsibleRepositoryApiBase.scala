...
/*
* WfResponsible Repository Api Base Trait for WfResponsible Repository
*
* Is a contract to define the repository api base WfResponsible Repository
* This class should not be modified since it is generated from the Application Dictionary 
* maybe any change made manually will be lost.
*/
trait wfResponsibleRepositoryApiBase[-R] {
