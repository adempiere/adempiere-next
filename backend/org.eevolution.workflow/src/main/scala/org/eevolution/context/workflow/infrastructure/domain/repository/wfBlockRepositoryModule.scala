...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfBlockRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfBlock Repository Module Package Object with the implementation for WfBlock Repository
*
* Default implementation to WfBlock Repository Base
...
*/
package object wfBlockRepositoryModule extends wfBlockRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfBlockRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfBlockRepository] =
      ZLayer.fromServices[
