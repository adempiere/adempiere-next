...
/*
* WorkflowProcessor Service Api Base Trait for WorkflowProcessor Domain Service
*
* Is a contract to define the repository api base WorkflowProcessor Domain Service
* This class should not be modified since it is generated from the Application Dictionary 
* maybe any change made manually will be lost.
*/
trait workflowProcessorServiceApiBase[-R] {
