...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWorkflowAccessServiceBase

/*
* gRPC WorkflowAccess Service Module Package Object with the implementation for gRPC WorkflowAccess Service
*
* Default implementation to gRPC WorkflowAccess Service Base
...
*/
package object gRPCWorkflowAccessServiceModule extends gRPCWorkflowAccessServiceBase {

  object Service extends Service[WorkflowAccessService with WorkflowAccessRepository] {
