...
/*
* WfNextCondition Service Api Base Trait for WfNextCondition Domain Service
*
* Is a contract to define the repository api base WfNextCondition Domain Service
* This class should not be modified since it is generated from the Application Dictionary 
* maybe any change made manually will be lost.
*/
trait wfNextConditionServiceApiBase[-R] {
