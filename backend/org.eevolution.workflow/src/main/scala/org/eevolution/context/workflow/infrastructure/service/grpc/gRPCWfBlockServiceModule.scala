...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfBlockServiceBase

/*
* gRPC WfBlock Service Module Package Object with the implementation for gRPC WfBlock Service
*
* Default implementation to gRPC WfBlock Service Base
...
*/
package object gRPCWfBlockServiceModule extends gRPCWfBlockServiceBase {

  object Service extends Service[WfBlockService with WfBlockRepository] {
