...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfActivityResultRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfActivityResult Repository Module Package Object with the implementation for WfActivityResult Repository
*
* Default implementation to WfActivityResult Repository Base
...
*/
package object wfActivityResultRepositoryModule extends wfActivityResultRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfActivityResultRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfActivityResultRepository] =
      ZLayer.fromServices[
