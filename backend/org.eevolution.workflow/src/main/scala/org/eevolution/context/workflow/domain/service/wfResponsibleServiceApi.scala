...
import org.eevolution.context.workflow.domain.service.{
  wfResponsibleServiceApiAccessors,
  wfResponsibleServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfResponsible Service Api Package Object for WfResponsible Domain Service
*
* Is a contract to define the service api WfResponsible Domain Service
...
*/
package object wfResponsibleServiceApi extends wfResponsibleServiceApiAccessors {

type WfResponsibleService = Has[WfResponsibleService.Service]

object WfResponsibleService {

     trait Service extends wfResponsibleServiceApiBase[WfResponsibleRepository] {
