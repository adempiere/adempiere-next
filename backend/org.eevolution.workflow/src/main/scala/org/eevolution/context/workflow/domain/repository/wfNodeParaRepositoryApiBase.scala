...
/*
* WfNodePara Repository Api Base Trait for WfNodePara Repository
*
* Is a contract to define the repository api base WfNodePara Repository
* This class should not be modified since it is generated from the Application Dictionary 
* maybe any change made manually will be lost.
*/
trait wfNodeParaRepositoryApiBase[-R] {
