...
/*
* WfNodeTrl Service Api Base Trait for WfNodeTrl Domain Service
*
* Is a contract to define the repository api base WfNodeTrl Domain Service
* This class should not be modified since it is generated from the Application Dictionary 
* maybe any change made manually will be lost.
*/
trait wfNodeTrlServiceApiBase[-R] {
