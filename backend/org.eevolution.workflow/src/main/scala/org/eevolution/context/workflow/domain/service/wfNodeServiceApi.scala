...
import org.eevolution.context.workflow.domain.service.{
  wfNodeServiceApiAccessors,
  wfNodeServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfNode Service Api Package Object for WfNode Domain Service
*
* Is a contract to define the service api WfNode Domain Service
...
*/
package object wfNodeServiceApi extends wfNodeServiceApiAccessors {

type WfNodeService = Has[WfNodeService.Service]

object WfNodeService {

     trait Service extends wfNodeServiceApiBase[WfNodeRepository] {
