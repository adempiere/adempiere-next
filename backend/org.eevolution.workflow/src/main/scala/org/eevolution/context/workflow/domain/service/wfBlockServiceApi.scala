...
import org.eevolution.context.workflow.domain.service.{
  wfBlockServiceApiAccessors,
  wfBlockServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfBlock Service Api Package Object for WfBlock Domain Service
*
* Is a contract to define the service api WfBlock Domain Service
...
*/
package object wfBlockServiceApi extends wfBlockServiceApiAccessors {

type WfBlockService = Has[WfBlockService.Service]

object WfBlockService {

     trait Service extends wfBlockServiceApiBase[WfBlockRepository] {
