...
import org.eevolution.context.workflow.domain.service.{
  wfActivityServiceApiAccessors,
  wfActivityServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfActivity Service Api Package Object for WfActivity Domain Service
*
* Is a contract to define the service api WfActivity Domain Service
...
*/
package object wfActivityServiceApi extends wfActivityServiceApiAccessors {

type WfActivityService = Has[WfActivityService.Service]

object WfActivityService {

     trait Service extends wfActivityServiceApiBase[WfActivityRepository] {
