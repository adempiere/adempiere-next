...
import org.eevolution.context.workflow.infrastructure.domain.repository.workflowProcessorLogRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WorkflowProcessorLog Repository Module Package Object with the implementation for WorkflowProcessorLog Repository
*
* Default implementation to WorkflowProcessorLog Repository Base
...
*/
package object workflowProcessorLogRepositoryModule extends workflowProcessorLogRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WorkflowProcessorLogRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WorkflowProcessorLogRepository] =
      ZLayer.fromServices[
