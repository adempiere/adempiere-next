...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfActivityServiceBase

/*
* gRPC WfActivity Service Module Package Object with the implementation for gRPC WfActivity Service
*
* Default implementation to gRPC WfActivity Service Base
...
*/
package object gRPCWfActivityServiceModule extends gRPCWfActivityServiceBase {

  object Service extends Service[WfActivityService with WfActivityRepository] {
