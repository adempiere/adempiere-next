...
/**
* Accessors method Trait for WfEventAudit Repository 
*
...
*/
trait wfEventAuditRepositoryApiAccessors {

  def getByAttributeName(attributeName: Option[String]): RIO[WfEventAuditRepository, List[WfEventAudit]] =
   RIO.accessM(_.get.getByAttributeName(attributeName))
   
  def getByWfEventAuditId(wfEventAuditId: Id): RIO[WfEventAuditRepository, Option[WfEventAudit]] =
   RIO.accessM(_.get.getByWfEventAuditId(wfEventAuditId))
   
  def getByDescription(description: Option[String]): RIO[WfEventAuditRepository, List[WfEventAudit]] =
   RIO.accessM(_.get.getByDescription(description))
   

  def getAll: RIO[WfEventAuditRepository, List[WfEventAudit]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WfEventAuditRepository, List[WfEventAudit]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
  def save(wfEventAudit: WfEventAudit): RIO[WfEventAuditRepository, WfEventAudit] = 
