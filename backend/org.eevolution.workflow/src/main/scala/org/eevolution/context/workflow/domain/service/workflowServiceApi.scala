...
import org.eevolution.context.workflow.domain.service.{
  workflowServiceApiAccessors,
  workflowServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* Workflow Service Api Package Object for Workflow Domain Service
*
* Is a contract to define the service api Workflow Domain Service
...
*/
package object workflowServiceApi extends workflowServiceApiAccessors {

type WorkflowService = Has[WorkflowService.Service]

object WorkflowService {

     trait Service extends workflowServiceApiBase[WorkflowRepository] {
