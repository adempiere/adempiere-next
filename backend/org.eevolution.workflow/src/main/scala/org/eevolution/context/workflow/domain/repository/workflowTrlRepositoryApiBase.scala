...
/*
* WorkflowTrl Repository Api Base Trait for WorkflowTrl Repository
*
* Is a contract to define the repository api base WorkflowTrl Repository
* This class should not be modified since it is generated from the Application Dictionary 
* maybe any change made manually will be lost.
*/
trait workflowTrlRepositoryApiBase[-R] {
