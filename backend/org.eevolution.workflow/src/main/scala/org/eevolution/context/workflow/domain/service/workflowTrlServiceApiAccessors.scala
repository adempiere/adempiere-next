...
/*
* Accessors method Trait for WorkflowTrl Domain Service 
*
...
*/
trait workflowTrlServiceApiAccessors {


  def getAll: RIO[WorkflowTrlService with WorkflowTrlRepository, List[WorkflowTrl]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WorkflowTrlService with WorkflowTrlRepository, List[WorkflowTrl]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
    def save(workflowTrl: WorkflowTrl): RIO[WorkflowTrlService with WorkflowTrlRepository, WorkflowTrl] =
    RIO.accessM(_.get.save(workflowTrl))  
