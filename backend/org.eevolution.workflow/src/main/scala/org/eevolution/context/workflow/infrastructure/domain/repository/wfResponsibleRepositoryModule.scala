...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfResponsibleRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfResponsible Repository Module Package Object with the implementation for WfResponsible Repository
*
* Default implementation to WfResponsible Repository Base
...
*/
package object wfResponsibleRepositoryModule extends wfResponsibleRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfResponsibleRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfResponsibleRepository] =
      ZLayer.fromServices[
