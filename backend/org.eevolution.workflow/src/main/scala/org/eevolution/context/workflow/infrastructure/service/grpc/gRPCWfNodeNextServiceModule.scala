...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfNodeNextServiceBase

/*
* gRPC WfNodeNext Service Module Package Object with the implementation for gRPC WfNodeNext Service
*
* Default implementation to gRPC WfNodeNext Service Base
...
*/
package object gRPCWfNodeNextServiceModule extends gRPCWfNodeNextServiceBase {

  object Service extends Service[WfNodeNextService with WfNodeNextRepository] {
