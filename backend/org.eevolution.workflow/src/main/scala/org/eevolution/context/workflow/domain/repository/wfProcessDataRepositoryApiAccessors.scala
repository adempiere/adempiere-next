...
/**
* Accessors method Trait for WfProcessData Repository 
*
...
*/
trait wfProcessDataRepositoryApiAccessors {

  def getByWfProcessId(wfProcessId: TableDirect): RIO[WfProcessDataRepository, List[WfProcessData]] =
   RIO.accessM(_.get.getByWfProcessId(wfProcessId))
   
  def getByAttributeName(attributeName: String): RIO[WfProcessDataRepository, List[WfProcessData]] =
   RIO.accessM(_.get.getByAttributeName(attributeName))
   
  def getByWfProcessDataId(wfProcessDataId: Id): RIO[WfProcessDataRepository, Option[WfProcessData]] =
   RIO.accessM(_.get.getByWfProcessDataId(wfProcessDataId))
   

  def getAll: RIO[WfProcessDataRepository, List[WfProcessData]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WfProcessDataRepository, List[WfProcessData]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
  def save(wfProcessData: WfProcessData): RIO[WfProcessDataRepository, WfProcessData] = 
