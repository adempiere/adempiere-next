...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfProcessDataRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfProcessData Repository Module Package Object with the implementation for WfProcessData Repository
*
* Default implementation to WfProcessData Repository Base
...
*/
package object wfProcessDataRepositoryModule extends wfProcessDataRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfProcessDataRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfProcessDataRepository] =
      ZLayer.fromServices[
