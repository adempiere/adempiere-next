...
/**
* Accessors method Trait for WorkflowAccess Repository 
*
...
*/
trait workflowAccessRepositoryApiAccessors {


  def getAll: RIO[WorkflowAccessRepository, List[WorkflowAccess]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WorkflowAccessRepository, List[WorkflowAccess]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
  def save(workflowAccess: WorkflowAccess): RIO[WorkflowAccessRepository, WorkflowAccess] = 
