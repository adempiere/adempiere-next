...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfProcessRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfProcess Repository Module Package Object with the implementation for WfProcess Repository
*
* Default implementation to WfProcess Repository Base
...
*/
package object wfProcessRepositoryModule extends wfProcessRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfProcessRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfProcessRepository] =
      ZLayer.fromServices[
