...
import org.eevolution.context.workflow.infrastructure.domain.repository.wfNextConditionRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* WfNextCondition Repository Module Package Object with the implementation for WfNextCondition Repository
*
* Default implementation to WfNextCondition Repository Base
...
*/
package object wfNextConditionRepositoryModule extends wfNextConditionRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WfNextConditionRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WfNextConditionRepository] =
      ZLayer.fromServices[
