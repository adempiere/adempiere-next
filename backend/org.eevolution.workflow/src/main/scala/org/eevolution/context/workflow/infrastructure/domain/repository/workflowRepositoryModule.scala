...
import org.eevolution.context.workflow.infrastructure.domain.repository.workflowRepositoryBase
import org.eevolution.context.kernel.infrastructure.databaseProviderApi.DatabaseProvider
import zio.blocking.Blocking
import zio.ZLayer

/*
* Workflow Repository Module Package Object with the implementation for Workflow Repository
*
* Default implementation to Workflow Repository Base
...
*/
package object workflowRepositoryModule extends workflowRepositoryBase {
 ...
 case class Live[Dialect <: SqlIdiom, Naming <: NamingStrategy](
  ...
  object WorkflowRepositoryLayer {
  
    val live: ZLayer[DatabaseProvider with Blocking, Nothing, WorkflowRepository] =
      ZLayer.fromServices[
