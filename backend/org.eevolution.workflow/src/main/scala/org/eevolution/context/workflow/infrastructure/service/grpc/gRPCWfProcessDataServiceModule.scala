...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfProcessDataServiceBase

/*
* gRPC WfProcessData Service Module Package Object with the implementation for gRPC WfProcessData Service
*
* Default implementation to gRPC WfProcessData Service Base
...
*/
package object gRPCWfProcessDataServiceModule extends gRPCWfProcessDataServiceBase {

  object Service extends Service[WfProcessDataService with WfProcessDataRepository] {
