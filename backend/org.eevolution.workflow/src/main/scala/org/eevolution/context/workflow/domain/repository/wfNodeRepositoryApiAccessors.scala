...
/**
* Accessors method Trait for WfNode Repository 
*
...
*/
trait wfNodeRepositoryApiAccessors {

  def getByWfNodeId(wfNodeId: Id): RIO[WfNodeRepository, Option[WfNode]] =
   RIO.accessM(_.get.getByWfNodeId(wfNodeId))
   
  def getByName(name: String): RIO[WfNodeRepository, Option[WfNode]] =
   RIO.accessM(_.get.getByName(name))
   
  def getByDescription(description: Option[String]): RIO[WfNodeRepository, List[WfNode]] =
   RIO.accessM(_.get.getByDescription(description))
   
  def getByWorkflowId(workflowId: TableDirect): RIO[WfNodeRepository, List[WfNode]] =
   RIO.accessM(_.get.getByWorkflowId(workflowId))
   
  def getByAttributeName(attributeName: Option[String]): RIO[WfNodeRepository, List[WfNode]] =
   RIO.accessM(_.get.getByAttributeName(attributeName))
   
  def getByValue(value: String): RIO[WfNodeRepository, Option[WfNode]] =
   RIO.accessM(_.get.getByValue(value))
   

  def getAll: RIO[WfNodeRepository, List[WfNode]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WfNodeRepository, List[WfNode]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
  def save(wfNode: WfNode): RIO[WfNodeRepository, WfNode] = 
