...
import org.eevolution.context.workflow.domain.service.{
  wfNodeNextServiceApiAccessors,
  wfNodeNextServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfNodeNext Service Api Package Object for WfNodeNext Domain Service
*
* Is a contract to define the service api WfNodeNext Domain Service
...
*/
package object wfNodeNextServiceApi extends wfNodeNextServiceApiAccessors {

type WfNodeNextService = Has[WfNodeNextService.Service]

object WfNodeNextService {

     trait Service extends wfNodeNextServiceApiBase[WfNodeNextRepository] {
