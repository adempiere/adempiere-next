...
/*
* Accessors method Trait for WfNodeTrl Domain Service 
*
...
*/
trait wfNodeTrlServiceApiAccessors {


  def getAll: RIO[WfNodeTrlService with WfNodeTrlRepository, List[WfNodeTrl]] =
    RIO.accessM(_.get.getAll)

  def getAllByClientId(tenantId: TableDirect): RIO[WfNodeTrlService with WfNodeTrlRepository, List[WfNodeTrl]] =
    RIO.accessM(_.get.getAllByClientId(tenantId))
    
    def save(wfNodeTrl: WfNodeTrl): RIO[WfNodeTrlService with WfNodeTrlRepository, WfNodeTrl] =
    RIO.accessM(_.get.save(wfNodeTrl))  
