...
import org.eevolution.context.workflow.domain.service.{
  wfProcessDataServiceApiAccessors,
  wfProcessDataServiceApiBase
}
import org.eevolution.context.kernel.domain.ubiquitouslanguage._
import zio.{Has, RIO, ZIO}

/*
* WfProcessData Service Api Package Object for WfProcessData Domain Service
*
* Is a contract to define the service api WfProcessData Domain Service
...
*/
package object wfProcessDataServiceApi extends wfProcessDataServiceApiAccessors {

type WfProcessDataService = Has[WfProcessDataService.Service]

object WfProcessDataService {

     trait Service extends wfProcessDataServiceApiBase[WfProcessDataRepository] {
