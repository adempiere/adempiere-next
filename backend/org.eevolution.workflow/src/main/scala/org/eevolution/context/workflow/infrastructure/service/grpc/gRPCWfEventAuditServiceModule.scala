...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfEventAuditServiceBase

/*
* gRPC WfEventAudit Service Module Package Object with the implementation for gRPC WfEventAudit Service
*
* Default implementation to gRPC WfEventAudit Service Base
...
*/
package object gRPCWfEventAuditServiceModule extends gRPCWfEventAuditServiceBase {

  object Service extends Service[WfEventAuditService with WfEventAuditRepository] {
