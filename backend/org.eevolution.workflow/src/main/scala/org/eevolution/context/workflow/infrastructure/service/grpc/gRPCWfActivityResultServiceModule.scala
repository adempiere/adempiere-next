...
import org.eevolution.context.workflow.infrastructure.service.grpc.gRPCWfActivityResultServiceBase

/*
* gRPC WfActivityResult Service Module Package Object with the implementation for gRPC WfActivityResult Service
*
* Default implementation to gRPC WfActivityResult Service Base
...
*/
package object gRPCWfActivityResultServiceModule extends gRPCWfActivityResultServiceBase {

  object Service extends Service[WfActivityResultService with WfActivityResultRepository] {
